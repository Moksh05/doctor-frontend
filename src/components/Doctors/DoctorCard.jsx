...
const DoctorCard = ({doctor}) => {
    const {name, avgRating, totalRating, specialization, totalPatients, photo, hospital} = doctor
  return (
    <div className='p-3 lg:p-5'>
        ...
        <div className='mt-[18px] lg:mt-5 flex items-center justify-between'>
            <div>
                <h3 className='text-[16px} lg:text-[18px] leading-7 lg:leading-[30px] font-semibold text-headingColo'>+{totalPatients} patients</h3>
