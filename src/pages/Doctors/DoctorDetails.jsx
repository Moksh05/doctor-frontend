        ...
        <div className='md:col-span-2'>
          <div className='flex items-center gap-5'>
            ...
            <div>
              ...
              <h3 className='text-headingColor text-[22px] leading-9 mt-3 font-bold'>XYZ</h3>
              ...
              <p className='text_para text-[14px] leading-6 md:text-[15px] lg:max-w[390px]'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptate, ad.</p>
            </div>
          </div>
