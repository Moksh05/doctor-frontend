...
const Home = () => {
  ...
  <section className="hero_section pt-[60px] 2xl:h-[800px]">
    <div className="container">
      <div className='flex flex-col lg:flex-row gap-[90px] items-center justifybetween'>
        <div>
          <div className='lg:w-[570px]'>
            ...
            <p className="text_para">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quam eum, molestias consequatur error, alias non molestiae modi rem amet eos numquam! At, magnam explicabo laboriosam dicta magni amet eum aut!</p>
            <button className='btn rounded-[50px]'>Request an Appointment</button>
          </div>
    ...
    <div className="container">
      <div className='flex items-center justify-between flex-col lg:flex-row'>
        <div className='xl:w-[670px]'>
          ...
          <Link to='/'><button className='btn rounded-[50px]'>Learn More</button></Link>
        </div>
        <div className='relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0'>
          <img src={featureImg} className='w-3/4 ' alt="" />
          <div className='w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:py-4 lg:px-4 lg:pb-[26px] rounded-[10px]'>
