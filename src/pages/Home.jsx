            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text_para">
                  ...
                  eum, molestias consequatur error, alias non molestiae modi rem
                  amet eos numquam! At, magnam explicabo laboriosam dicta magni
                  amet eum aut!
                </p>
                <button className="btn rounded-[50px]">
        ...
        <div className="container">
          <div className="flex items-center justify-between flex-col lg:flex-row">
            <div className="xl:w-[670px]">
              ...
              <Link to="/">
                <button className="btn rounded-[50px]">Learn More</button>
              </Link>
            </div>
